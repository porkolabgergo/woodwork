...
(function () {
  ...
  function removeCookieConsent(panel) {
    ...
    allPanels.forEach((p, index) => {
      ...
      try {
        if (p.parentNode) {
          ...
          console.log(
            "✓✓✓ Panel #" + (index + 1) + " REMOVED with removeChild"
          );
        } else {
          p.remove();
    ...
    setTimeout(() => {
      ...
      console.log(
        "Verification check - Panels still in DOM:",
        stillThere.length
      );
      if (stillThere.length > 0) {
        console.warn(
          "!!! " +
            stillThere.length +
            " PANEL(S) STILL EXIST, forcing removal !!!"
        );
        stillThere.forEach((p, i) => {
          ...
          try {
            ...
            console.error(
              "Force removal failed for panel #" + (i + 1) + ":",
              e
            );
          }
        });
        ...
        if (existingPanels.length > 0) {
          console.warn(
            "Found " +
              ...
              " existing panel(s) even though consent was given! Removing..."
          );
...
document.addEventListener("DOMContentLoaded", function () {
  const animatedElements = document.querySelectorAll(
    ".service-card, .gallery-item, .about-content, .contact-content"
  );
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  // Fixed gallery image paths
  const galleryImagePaths = [
    "assets/gallery/img_0.webp",
    "assets/gallery/img_1.webp",
    "assets/gallery/img_2.webp",
    "assets/gallery/img_3.webp",
    "assets/gallery/img_4.webp",
    "assets/gallery/img_5.webp",
    "assets/gallery/img_6.webp",
    "assets/gallery/img_7.webp",
    "assets/gallery/img_8.webp",
    "assets/gallery/img_9.webp",
    "assets/gallery/img_10.webp",
    "assets/gallery/img_11.webp",
    "assets/gallery/img_12.webp",
    "assets/gallery/img_13.webp",
    "assets/gallery/img_14.webp",
    "assets/gallery/img_15.webp",
    "assets/gallery/img_16.webp",
    "assets/gallery/img_17.webp",
    "assets/gallery/img_18.webp",
    "assets/gallery/img_19.webp",
    "assets/gallery/img_20.webp",
    "assets/gallery/img_21.webp",
    "assets/gallery/img_22.webp",
    "assets/gallery/img_23.webp",
    "assets/gallery/img_24.webp",
    "assets/gallery/img_25.webp",
    "assets/gallery/img_26.webp",
    "assets/gallery/img_27.webp",
    "assets/gallery/img_28.webp",
    "assets/gallery/img_29.webp",
    "assets/gallery/img_30.webp",
    "assets/gallery/img_31.webp",
  ];
  ...
  galleryImagePaths.forEach((path, index) => {
    galleryImages.push({
      ...
      description:
        "Egyedi faipari és belsőépítészeti megoldás - Balance Design Kft.",
    });
  });
  ...
  galleryItems.forEach((item, index) => {
    ...
    item.addEventListener("click", function () {
      ...
      const fullGalleryIndex = galleryImages.findIndex(
        (img) => img.src === clickedSrc
      );
  ...
  const galleryButtons = document.querySelectorAll(
    '.gallery-buttons a[href="#gallery"]'
  );
...
document.addEventListener("DOMContentLoaded", function () {
  const serviceData = {
    kitchen: {
      ...
      image: "assets/thumbnails/services_kitchen.webp",
      description: `
    ...
    wardrobe: {
      ...
      image: "assets/thumbnails/services_wardrobe.webp",
      description: `
    ...
    bathroom: {
      ...
      image: "assets/thumbnails/services_bathroom_cabinets.webp",
      description: `
    ...
    doors: {
      title: "Beltéri ajtók",
      image: "assets/thumbnails/services_doors.webp",
      description: `
    ...
    interior: {
      ...
      image: "assets/thumbnails/services_interior_design.webp",
      description: `
            ...
            `,
      features: ["Gipszkarton munkák", "Parketta és burkolat lerakás"],
    },
    "3d": {
      title: "3D látványterv kivitelezés",
      image: "assets/thumbnails/3dplan.jpg",
      description: `
    ...
    microcement: {
      title: "Mikrocement",
      image: "assets/thumbnails/services_microcement.webp",
      description: `
  ...
  serviceTiles.forEach((tile) => {
    tile.addEventListener("click", function () {
      ...
      if (service) {
        ...
        document.getElementById("serviceModalDescription").innerHTML =
          service.description;
  ...
  modal
    .querySelector(".service-modal-actions a")
